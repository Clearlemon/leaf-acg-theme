  ...
  CSF::createSection($prefix, array(
    ...
    'fields'      => array(
      ...
      array(
        ...
        'options'    => array(
          'text-logo' => $img_setings_url . 'texte-logo-deom.png',
          'img-logo' => $img_setings_url . 'img-logo-deom.png',
        ),
        'default' =>  'img-logo',
      ),
      array(
      ...
      array(
        ...
        'options'    => array(
          'mobile-bg-logo' => $img_setings_url . 'mobile-logo-bg.png',
          'mobile-img-logo' => $img_setings_url . 'mobile-logo-img.png',
          'mobile-home-img-logo' => $img_setings_url . 'mobile-home-logo-img.png'
        ),
  ...
  CSF::createSection($prefix, array(
    ...
    'fields'      => array(
      array(
        ...
        'options'    => array(
          'to-left' => $img_setings_url . 'nav-left-deom.png',
          'to-center' => $img_setings_url . 'nav-center-deom.png',
          'to-right' => $img_setings_url . 'nav-right-deom.png',
        ),
      ),
      array(
        'id'         => 'close-logo',
        ...
        'inline'     => true,
        'type'       => 'image_select',
        'desc' => '选择你喜欢的导航logo样式，第一个为<b class="leaf_emphasis_fonts">[背景图+LOGO图]</b>样式，第二个为纯<b class="leaf_emphasis_fonts">[LOGO图]</b>样式。',
        'options'    => array(
          'mobile-bg-logo' => $img_setings_url . 'mobile-logo-bg.png',
          'mobile-img-logo' => $img_setings_url . 'mobile-logo-img.png',
