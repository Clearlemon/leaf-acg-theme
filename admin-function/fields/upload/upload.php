    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        if (!isset($args['preview']) || !!$args['preview']) {
          echo '<div class="feng-preview' . esc_attr($hidden) . '">';
          if (preg_match('/\.(mp4|wma)$/', $this->value)) {
              echo '<div class="feng-image-div"><a href="#" class="csf--remove feng-times"><i class="fa-solid fa-xmark"></i></a><a target="_blank" href="' . esc_url($this->value) . '"><video src="' . esc_url($this->value) . '" class="feng-url" controls></video></a></div>';
          } else {
              echo '<div class="feng-image-div"><a href="#" class="csf--remove feng-times"><i class="fa-solid fa-xmark"></i></a><a target="_blank" href="' . esc_url($this->value) . '"><img src="' . esc_url($this->value) . '" class="feng-url" /></a></div>';
          }
          echo '</div>';
        }
